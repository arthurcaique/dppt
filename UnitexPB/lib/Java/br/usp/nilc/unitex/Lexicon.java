...
public class Lexicon {
	...
	private boolean carregado; // informa se o dicionário está ou não carregado
	...
	/**
	 * A rotina 'CarregaDicionário' carrega o dicionário compactado.
	 * @param path_dic Deve fornecer a localização (absoluta ou
	 ...
	 * @param path_alph Deve fornecer a localização (absoluta ou
	 * relativa) do arquivo que contém o alfabeto.
	 * @return Devolve um código de controle:<br>
	 * 0 - Término normal da operação.<br>
