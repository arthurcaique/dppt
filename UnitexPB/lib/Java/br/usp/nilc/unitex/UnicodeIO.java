...
public class UnicodeIO {
    ...
    */
   public static String readFirstLine(String name) {
...
/*   public static FileInputStream openUnicodeLittleEndianFileInputStream(String f)
      throws NotAUnicodeLittleEndianFileException, FileNotFoundException {
      FileInputStream stream= new FileInputStream(getClass().getResource(f));
      if (UnicodeIO.readChar(stream) != 0xFEFF) {
         throw new NotAUnicodeLittleEndianFileException();
      }
      return stream;
