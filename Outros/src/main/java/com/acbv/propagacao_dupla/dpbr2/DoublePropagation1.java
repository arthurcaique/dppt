 ...
 * @author Arthur
 */
public class DoublePropagation1 {
    ...
    public void runDP(Corpus corpus, Set<String> lexico, Set<String> stopSubWords) {
        try {
            ...
            for (Frase frase : frases) {
                ...
                alvosExtraidos_i.addAll(extracao.extractAspectsUsingR5(frase, lexicoExpandido, aspectosExtraidos));
                alvosExtraidos_i.addAll(extracao.extractAspectsUsingR6(frase, lexicoExpandido, aspectosExtraidos));
